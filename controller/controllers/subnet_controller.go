...
// +kubebuilder:rbac:groups=network.crd.firemiles.top,resources=subnets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=network.crd.firemiles.top,resources=subnets/status,verbs=get;update;patch
